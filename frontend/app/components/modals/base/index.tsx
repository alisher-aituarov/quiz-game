        ...
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                <div className="flex items-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <span
                        className="hidden sm:inline-block items-center align-middle sm:align-middle sm:h-screen"
                        aria-hidden="true"
                    >
                        &#8203;
                    </span>
                    ...
                    >
                        <div className="relative w-full inline-block align-bottom bg-white rounded-lg text-left shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg">
